...
public class Destinations extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //TO:DO need to send destinations as list of objects with ID
        // that can be referenced on button click in jsp page
        //create bean for calling DB
        
        //send test images
        images.add("https://360player.io/p/wqosLr/");
        images.add("https://360player.io/p/wqosLr/");
        images.add("https://360player.io/p/wqosLr/");
        request.setAttribute("imageList", images);
        request.setAttribute("message", "hello from destinations servlet");
        //load page
